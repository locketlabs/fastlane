...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency('google-cloud-env', '>= 2.2.0', '< 3.0.0') # Needed for googleauth versions that support jwt 3.x
  ...
  spec.add_dependency('jwt', '>= 3.2.0', '< 4.0') # Used for generating authentication tokens for App Store Connect API
